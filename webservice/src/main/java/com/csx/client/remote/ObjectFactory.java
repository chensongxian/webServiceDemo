 ...
 * generated in the com.csx.client.remote package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAddressByPhoneNo_QNAME = new QName("http://impl.server.csx.com/", "getAddressByPhoneNo");
    private final static QName _GetAddressByPhoneNoResponse_QNAME = new QName("http://impl.server.csx.com/", "getAddressByPhoneNoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.csx.client.remote
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.server.csx.com/", name = "getAddressByPhoneNo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.server.csx.com/", name = "getAddressByPhoneNoResponse")
